                        ...
                        <div className="bigcard">
                            <div className="cardin">
                                <div className="top">
                                    ...
                                    <p className="text">
                                        Наши сотрудники — основа нашего успеха. В компании работает 250 квалифицированных специалистов, каждый из которых вносит свой вклад в развитие и рост нашей продукции.</p>
                                </div>
